...
class Kecamatan extends Controller
{
    ...
    public function ekspor_rekap(int|string $id, int|string $th): JsonResponse
    {
        try {
            ...
            return Response::json(['status' => 'error', 'message' => 'Gagal mengekspor rekap: ' . $throwable->getMessage()], 500);
        }
    }
}