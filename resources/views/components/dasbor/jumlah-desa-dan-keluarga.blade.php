<section class="mt-8 cursor-default grid grid-cols-1 gap-4 lg:grid-cols-2">
    <div class="bg-green-dark overflow-hidden p-4 rounded-xl relative text-white lg:p-6">
        <h3 class="mb-2 opacity-80 text-base lg:text-lg">Jumlah Desa</h3>
        <h5 class="relative z-10 text-3xl font-bold lg:text-4xl">
            {{ $jumlah_desa }}
        </h5>
    ...
    <div class="bg-green-medium overflow-hidden p-4 rounded-xl relative text-white lg:p-6">
        <h3 class="mb-2 opacity-80 text-base lg:text-lg">Jumlah Keluarga</h3>
        <h5 class="relative z-10 text-3xl font-bold lg:text-4xl">
            {{ $jumlah_keluarga }}
        </h5>
