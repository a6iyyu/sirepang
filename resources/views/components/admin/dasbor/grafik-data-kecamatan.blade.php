<section class="bg-green-medium mt-6 w-full overflow-x-auto rounded-2xl bg-transparent p-4 md:p-6">
    ...
    <figure class="w-full overflow-x-auto">
        <div id="column-chart" class="inline-block max-h-60 h-full w-fit min-w-[800px]"></div>
