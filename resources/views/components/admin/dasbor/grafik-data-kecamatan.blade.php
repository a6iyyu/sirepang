<section class="max-w-8xl bg-green-medium mt-6 w-full overflow-x-auto rounded-2xl bg-transparent p-4 md:p-6">
    <div class="mb-4 flex min-w-[800px] justify-between text-white">
        ...
        <span class="relative mt-4 flex items-center space-x-4 md:mt-0">
            <select class="appearance-none rounded-lg bg-slate-50 py-2.5 pr-14 pl-4 font-semibold text-emerald-600 shadow-lg focus:ring-2 focus:ring-slate-300 focus:outline-none">
...
@push('skrip')
    <script>
        window.chartData = @json($data_grafik);
    </script>
@endpush