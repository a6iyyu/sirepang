<section class="mt-8 grid cursor-default grid-cols-1 gap-4 lg:grid-cols-2">
    <div class="bg-green-dark relative overflow-hidden rounded-xl p-4 text-white lg:p-6">
        <h3 class="mb-2 text-sm opacity-80">Jumlah Desa</h3>
        <h5 class="relative z-10 text-xl font-bold lg:text-2xl">
            {{ $jumlah_desa }}
        </h5>
    ...
    <div class="bg-green-medium relative overflow-hidden rounded-xl p-4 text-white lg:p-6">
        <h3 class="mb-2 text-sm opacity-80">Jumlah Keluarga</h3>
        <h5 class="relative z-10 text-xl font-bold lg:text-2xl">
            {{ $jumlah_keluarga }}
        </h5>
