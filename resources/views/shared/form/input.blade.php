<fieldset class="@if (empty($info)) space-y-4 @endif flex w-full flex-col justify-between">
    ...
    <div class="relative">
        ...
        <input
            ...
            type="{{ $type ?? 'text' }}"
            id="{{ $name }}"
            class="@error($name) @enderror w-full appearance-none rounded-lg border-2 border-red-500 py-2.75 pr-4 pl-12 transition-all duration-200 focus:border-[#1a4167] focus:ring-2 focus:ring-[#1a4167]/20 focus:outline-none"
            value="{{ $value }}"
