<figure class="grid cursor-pointer grid-cols-1 text-sm transition-all duration-200 hover:bg-emerald-50/50 md:grid-cols-2">
    <div class="flex items-center p-4 md:p-5">
        <span class="mr-4 h-12 w-1.5 rounded-full bg-emerald-700"></span>
        <h5 class="font-medium text-emerald-800">{{ $name }}</h5>
    </div>
