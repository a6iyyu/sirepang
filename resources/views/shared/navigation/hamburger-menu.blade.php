        ...
        <div class="space-y-4 overflow-y-auto pr-2 scrollbar-thin scrollbar-thumb-slate-400 scrollbar-track-transparent" style="max-height: calc(100vh - 200px)">
            ...
            @if (Auth::check() && Auth::user()->tipe == 'admin')
                ...
                <a
                    ...
                    class="{{ 'group z-30 relative flex items-center px-4 py-3 rounded-xl transition-all transform duration-300 ease-in-out ' . (Request::is('admin/rekap-pangan', 'admin/rekap-pangan/detail/*') ? 'bg-primary text-green-dark' : 'text-white hover:bg-green-light/50 hover:scale-105 hover:shadow-md') }}"
                >
