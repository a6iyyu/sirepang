<i
    id="hamburger-menu"
    class="fa-solid fa-bars bg-green-dark fixed top-10 right-10 z-20 flex cursor-pointer rounded-lg p-2 text-xl text-white transition-opacity duration-300 lg:!hidden"
></i>
<aside
    id="mobile"
    class="bg-green-dark fixed top-0 left-0 z-30 min-h-screen -translate-x-full transform space-y-4 rounded-r-2xl p-6 shadow-2xl transition-transform duration-300 ease-in-out"
>
